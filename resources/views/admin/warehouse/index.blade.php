                ...
                <div class="page-header-content">
                    <div class="row align-items-center justify-content-between">
                        ...
                        <div class="col-auto my-4">
                            <a href="{{ route('admin.warehouse.create') }}" class="btn btn-primary add-list">
                                <i class="fa-solid fa-plus me-3"></i>
                                Add
                            </a>
                            <a href="{{ route('admin.warehouse.index') }}" class="btn btn-danger add-list">
                        ...
                        <div class="col-lg-12">
                            <div class="table-responsive">
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        @foreach ($warehouses as $warehouse)
                                            <tr>
                                                <th scope="row">
                                                    {{ $warehouses->currentPage() * (request('row') ? request('row') : 10) - (request('row') ? request('row') : 10) + $loop->iteration }}
                                                </th>
                                                ...
                                                <td>
                                                    <div class="d-flex">
                                                        ...
                                                        <button type="button" class="btn btn-outline-primary btn-sm mx-1"
                                                            ...
                                                            data-bs-target="#edit{{ $warehouse->id }}">
                                    ...
                                    ====================================     --}}
                                    @foreach ($warehouses as $warehouse)
                                        <div class="modal fade" id="edit{{ $warehouse->id }}" tabindex="-1"
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <a href="{{ url('admin/warehouse/edit/' . $warehouse->id) }}">
                                ...
                                ====================================     --}}
                                    ...
                                    @foreach ($warehouses as $warehouse)
                                        <div class="modal fade" id="delete{{ $warehouse->id }}" tabindex="-1"
                                            aria-labelledby="exampleModalLabel" aria-hidden="true">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                    ...
                                                    <div class="modal-footer">
                                                        <button type="button" class="btn btn-danger"
                                                            data-bs-dismiss="modal">No</button>
                                                        <a href="{{ url('admin/warehouse/destroy/' . $warehouse->id) }}">
                                                            <button type="button" class="btn btn-danger">
                                                                Yes
                                                            </button>
                                                        </a>
