                ...
                <div class="col-xl-6">
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                                        ...
                                        @foreach ($carts as $item)
                                            <tr>
                                                ...
                                                <td style="min-width: 170px;">
                                                    <form action="{{ route('admin.pos.updateCartItem', $item->rowId) }}"
                                                        method="POST">
                                                        @csrf
                                                        <div class="input-group">
                                                            ...
                                                            <div class="input-group-append">
                                                                <button type="submit" class="btn btn-success border-none"
                                                                    ...
                                                                    title="" data-original-title="Sumbit"><i
                                                ...
                                                <td>
                                                    <div class="d-flex">
                                                        <form action="{{ route('admin.pos.deleteCartItem', $item->rowId) }}"
                                                            method="POST">
                                                            @method('delete')
                                                            @csrf
                            ...
                            <form action="{{ route('admin.pos.createInvoice') }}" method="POST">
                                @csrf
                                <div class="row mb-3">
                                    <div class="col-md-12">
                                    ...
                                    <table class="table table-striped align-middle">
                                        ...
                                        <div style="max-height: 80px; max-width: 80px;">
                                            <img class="img-fluid"  src="{{ $product->product_image ? asset('storage/products/'.$product->product_image) : asset('assets/img/products/default.webp') }}">
                                                    ...
                                                    <td>
                                                        <div class="d-flex">
                                                            <form action="{{ route('admin.pos.addCartItem', $product->id) }}"
                                                                method="POST">
                                                                @csrf
