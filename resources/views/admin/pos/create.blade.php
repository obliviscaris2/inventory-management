        ...
        <div class="row">
            <div class="col-lg-12">
                    ...
                    <div class="invoice-info">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6 text-end mb-50">
                                ...
                                <p class="inv-from-1">(+977) 123 123 123</p>
                                <p class="inv-from-1">email@example.com</p>
                                <p class="inv-from-2">Kathmandu, Nepal</p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="invoice-btn-section clearfix d-print-none">
                    <a class="btn btn-lg btn-primary" href="{{ route('admin.pos.index') }}">
                        Back
                    </a>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h3 class="modal-title text-center mx-auto" id="modalCenterTitle">Invoice of {{ $customer->name }}<br/>Total Amount Rs.{{ Cart::total() }}</h3>
            </div>

            <form action="{{ route('admin.pos.createOrder') }}" method="POST">
                @csrf
