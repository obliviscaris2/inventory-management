                ...
                <div class="page-header-content">
                    <div class="row align-items-center justify-content-between">
                        ...
                        <div class="col-auto my-4">
                            <a href="{{ route('admin.customer.create') }}" class="btn btn-primary add-list">
                                <i class="fa-solid fa-plus me-3"></i>
                                Add
                            </a>
                            <a href="{{ route('admin.customer.index') }}" class="btn btn-danger add-list">
                            ...
                            <form action="{{ route('admin.customer.index') }}" method="GET">
                                <div class="d-flex flex-wrap align-items-center justify-content-between">
                                    <div class="d-flex flex-wrap gap-2">
                                        ...
                                        <button class="btn btn-sm btn-outline-primary" style="height: 35px;"
                                ...
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        @foreach ($customers as $customer)
                                            <tr>
                                                <th scope="row">
                                                    {{ $customers->currentPage() * (request('row') ? request('row') : 10) - (request('row') ? request('row') : 10) + $loop->iteration }}
                                                </th>
                                                <td>{{ $customer->name }}</td>
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        <button type="button" class="btn btn-danger"
                                                            data-bs-dismiss="modal">No</button>
                                                        <a href="{{ url('admin/customer/destroy/' . $customer->id) }}">
                                                            <button type="button" class="btn btn-danger">
                                                                Yes
                                                            </button>
                                                        </a>
