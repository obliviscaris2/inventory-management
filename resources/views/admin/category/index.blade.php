                ...
                <div class="page-header-content">
                    <div class="row align-items-center justify-content-between">
                        ...
                        <div class="col-auto my-4">
                            <a href="{{ route('admin.category.create') }}" class="btn btn-primary add-list">
                                <i class="fa-solid fa-plus me-3"></i>
                                Add
                            </a>
                            <a href="{{ route('admin.category.index') }}" class="btn btn-danger add-list">
                                ...
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        @foreach ($categories as $category)
                                            <tr>
                                                <th scope="row">
                                                    {{ $categories->currentPage() * (request('row') ? request('row') : 10) - (request('row') ? request('row') : 10) + $loop->iteration }}
                                                </th>
                                                <td>{{ $category->name }}</td>
                                                <td>{{ $category->slug }}</td>
                                                <td>
