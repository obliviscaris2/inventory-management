                ...
                <div class="page-header-content">
                    <div class="row align-items-center justify-content-between">
                        ...
                        <div class="col-auto my-4">
                            <a href="{{ route('admin.supplier.create') }}" class="btn btn-primary add-list">
                                <i class="fa-solid fa-plus me-3"></i>
                                Add
                            </a>
                            <a href="{{ route('admin.supplier.index') }}" class="btn btn-danger add-list">
                        ...
                        <div class="col-lg-12">
                            <div class="table-responsive">
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        @foreach ($suppliers as $supplier)
                                            <tr>
                                                <th scope="row">
                                                    {{ $suppliers->currentPage() * (request('row') ? request('row') : 10) - (request('row') ? request('row') : 10) + $loop->iteration }}
                                                </th>
                                                <td>{{ $supplier->name }}</td>
                                                ...
                                                <td>
                                                    <div class="d-flex">
                                                        ...
                                                        <button type="button" class="btn btn-outline-primary btn-sm mx-1"
                                                            ...
                                                            data-bs-target="#edit{{ $supplier->id }}">
                                    ...
                                    ====================================     --}}
                                    @foreach ($suppliers as $supplier)
                                        <div class="modal fade" id="edit{{ $supplier->id }}" tabindex="-1"
                                ...
                                ====================================     --}}
                                    ...
                                    @foreach ($suppliers as $supplier)
                                        <div class="modal fade" id="delete{{ $supplier->id }}" tabindex="-1"
                                            aria-labelledby="exampleModalLabel" aria-hidden="true">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                    ...
                                                    <div class="modal-footer">
                                                        <button type="button" class="btn btn-danger"
                                                            data-bs-dismiss="modal">No</button>
                                                        <a href="{{ url('admin/supplier/destroy/' . $supplier->id) }}">
                                                            <button type="button" class="btn btn-danger">
                                                                Yes
                                                            </button>
                                                        </a>
