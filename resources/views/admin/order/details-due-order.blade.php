                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <button class="btn btn-success" type="button" data-bs-toggle="modal"
                                data-bs-target="#modal">Pay Due</button>
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <h3 class="modal-title text-center mx-auto" id="modalCenterTitle">Invoice of
                            {{ $order->customer->name }}<br />Total Amount <b>${{ $order->total }}</b></h3>
                    </div>

                    <form action="{{ route('admin.order.updateDueOrder') }}" method="POST">
                        @csrf
                        @method('put')
                        <div class="modal-body">
                            <div class="modal-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('pay') is-invalid @enderror"
