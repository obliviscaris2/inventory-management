            ...
            <nav class="navbar navbar-light navbar-vertical navbar-expand-xl">
                ...
                <div class="d-flex align-items-center">
                    <div class="toggle-icon-wrapper">
                        ...
                        <div class="d-flex align-items-center py-3"><img class="me-2" src="" alt=""
                    ...
                    <div class="navbar-vertical-content scrollbar">
                        <ul class="navbar-nav flex-column mb-3" id="navbarVerticalNav">
                            <li class="nav-item">
                                ...
                                <ul class="nav collapse show" id="dashboard">
                                    ...
                                    <li class="nav-item"><a class="nav-link active"
                                            ...
                                            <div class="d-flex align-items-center"><span
                                                    class="nav-link-text ps-1">Admin</span></div>
                                        </a><!-- more inner pages-->
                                    </li>
                                </ul>
                            </li>
                                ...
                                <a class="nav-link" href="{{ route('admin.pos.index') }}" role="button">
                                    <div class="d-flex align-items-center">
                                        <span class="nav-link-icon">
                                            <svg class="svg-inline--fa fa-calendar-alt fa-w-14" aria-hidden="true"
                            ...
                            <li class="nav-item">
                                ...
                                <a class="nav-link" href="{{ route('admin.purchase.dailyPurchaseReport') }}" role="button">
                                    <div class="d-flex align-items-center">
                                        <span class="nav-link-icon">
                                        </span>
